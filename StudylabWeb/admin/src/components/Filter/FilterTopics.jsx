...
import { SelectPicker,CustomProvider,IconButton } from 'rsuite';
    ...
    <div className="flex flex-col col">
        <CustomProvider locale={ptBR} > 
            <SelectPicker
                ...
                className="hidden-selector !rounded-md !border !shadow-sm 
                            !px-0 !py-0 !bg-white text-sm font-medium text-gray-700 
                            hover:!bg-gray-100 focus:!outline-none focus:!ring-2 
                            focus:!ring-offset-2 focus:!ring-indigo-10"
                />
