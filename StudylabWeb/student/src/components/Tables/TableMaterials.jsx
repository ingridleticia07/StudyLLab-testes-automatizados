...
const EYE_FILTER = 'invert(48%) sepia(79%) saturate(2476%) hue-rotate(360deg) brightness(98%) contrast(91%)';

const TableMaterialsReadOnly = ({ data, currentPage, setCurrentPage, hasData }) => {
