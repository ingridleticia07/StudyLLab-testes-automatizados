...
const EditTopic = ({ handleCancel, setIterationData, currentPage,selectDisciplinas,selectedItem }) => {
   
  const initialFormData = {
    nome: selectedItem.item.nomeTopico || '',
    disciplina: selectedItem.item.disciplina.idDisciplina || '',
    idTopico:selectedItem.item.idTopico,
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setState((prev) => ({
        ...prev,
        errorMessage: error?.response?.data || 'Erro ao editar tópico.',
        showError: true,
      }));
    } finally {
            ...
            <div className="flex flex-col" key={field.id}>
                ...
                <>
                    <SelectPicker
                      ...
                      defaultValue={formData.disciplina}
                      onChange={handleChange(field.name)}
                    />
