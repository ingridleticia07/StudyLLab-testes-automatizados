...
const AuthFooter = ({showFirstLink = true, showSecondLink = true }) => {
    return (
        <footer className='mt-6 text-sm text-center fleex flex-row items-center'>
            {showFirstLink &&
                <Link to={'/inicio'} className="mr-6 bg-white/20 hover:bg-white/10 text-white py-2 px-4 rounded-md inline-block">
