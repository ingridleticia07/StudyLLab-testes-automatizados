...
const HomeMadeStudents = () => {
  return (
    <section className="text-center items-center flex justify-between pt-16 pb-28 flex-col lg:flex-row max-w-80 xs:max-w-md sm:max-w-xl md:max-w-2xl lg:max-w-4xl xl:max-w-[1150px] w-full">
      <h3 className="text-2xl sm:text-3xl md:text-4xl xl:text-5xl text-gray-600 mb-8 text-center lg:text-start">
      ...
      <div className="flex flex-col items-center gap-2">
        <div className="flex justify-center gap-8 sm:gap-10 md:gap-12 xl:gap-16 xs:pr-11 sm:pr-16 md:pr-20 xl:pr-24">
          <img src={studentsImages.prof1} alt="Prof 0" className="w-14 h-14 sm:w-20 sm:h-20 md:w-24 md:h-24 xl:w-32 xl:h-32 rounded-full" />
        ...
        <div className="flex justify-center gap-8 sm:gap-10 md:gap-12 xl:gap-16 xs:pr-11 sm:pr-16 md:pr-20 xl:pr-24">
          ...
          <img src={studentsImages.student12} alt="Student 12" className="w-14 h-14 sm:w-20 sm:h-20 md:w-24 md:h-24 xl:w-32 xl:h-32 rounded-full" />
          <img src={studentsImages.student13} alt="Student 13" className="w-14 h-14 sm:w-20 sm:h-20 md:w-24 md:h-24 xl:w-32 xl:h-32 rounded-full" />
        </div>

        <div className="flex justify-center gap-8 sm:gap-10 md:gap-12 xl:gap-16 xs:pl-11 sm:pl-14 md:pl-16 xl:pl-24">
          <img src={studentsImages.student14} alt="Student 14" className="w-14 h-14 sm:w-20 sm:h-20 md:w-24 md:h-24 xl:w-32 xl:h-32 rounded-full" />
          <img src={studentsImages.student15} alt="Student 15" className="w-14 h-14 sm:w-20 sm:h-20 md:w-24 md:h-24 xl:w-32 xl:h-32 rounded-full" />
          <img src={studentsImages.student16} alt="Student 16" className="w-14 h-14 sm:w-20 sm:h-20 md:w-24 md:h-24 xl:w-32 xl:h-32 rounded-full" />
        </div>
        ...
        <div className="flex justify-center gap-8 sm:gap-10 md:gap-12 xl:gap-16 xs:pr-11 sm:pr-16 md:pr-20 xl:pr-24">
          <img src={studentsImages.student25} alt="Student 25" className="w-14 h-14 sm:w-20 sm:h-20 md:w-24 md:h-24 xl:w-32 xl:h-32 rounded-full" />
          <img src={studentsImages.student26} alt="Student 26" className="w-14 h-14 sm:w-20 sm:h-20 md:w-24 md:h-24 xl:w-32 xl:h-32 rounded-full" />
        </div>
      </div>
    </section>
  );
