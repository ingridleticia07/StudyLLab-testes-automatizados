const getPasswordStrength = (password) => {
  ...
  if (score === 2 || score === 3) return { label: 'Fraca!', color: 'bg-yellow-500' };
...
const PasswordValidation = ({ password }) => {
  ...
  return (
      <div className="mt-2 items-center justify-center flex flex-col">
          ...
          <p className="mt-3">Sua senha precisa ter no mínimo 8 caracteres e deve conter números<br /> e letras minúsculas e maiúsculas</p>
      </div>
  );
};
